...
public class ServicePackageDetailSPI extends StoredProcedure {
	private static final String SPROC_NAME = "spi_mirada_package_detail";
	...
	@Autowired
	public ServicePackageDetailSPI(DataSource dataSource){
